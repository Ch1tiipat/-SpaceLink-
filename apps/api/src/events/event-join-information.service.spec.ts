...
describe('EventJoinInformationService', () => {
  let service: EventJoinInformationService;
  ...
  beforeEach(async () => {
    ...
    service = module.get(EventJoinInformationService);
  });
  ...
  it('updates only an item belonging to the scoped event', async () => {
    ...
    informationUpdate.mockResolvedValue({ id: FIRST_ID, title: 'เวลาใหม่' });
