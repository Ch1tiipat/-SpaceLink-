...
const { ADMIN_TIMELINE_TYPES, describeAdminTimelineItem, timelineTone } =
...
timelineTest(
  'describes status and decimal amount without floating-point conversion',
  () => {
    timelineAssert.deepEqual(
      ...
      {
        label: 'ตรวจสอบสลิปสำเร็จ',
        detail: 'สถานะ VERIFIED · ยอด ฿1,234,567.50',
        tone: 'green',
      },
    );
  },
...
timelineTest(
  'assigns warning and failure tones to refund and cancellation milestones',
  () => {
