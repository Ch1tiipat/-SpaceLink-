      ...
      <article className="shell py-8 sm:py-12">
        <header className="overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#29134f,#6d28d9_58%,#7257d9)] px-6 py-9 text-white shadow-[0_24px_65px_rgba(49,27,89,.18)] sm:px-10 sm:py-12">
          ...
          <p className="mt-4 max-w-3xl leading-7 text-white/80">
            ข้อตกลงเบื้องต้นสำหรับการใช้ SpaceLink เพื่อค้นหา Event
            จัดการร้านค้า และจองพื้นที่ขายสินค้า
          </p>
        </header>
        ...
        <div className="mt-7 grid gap-5">
          <LegalSection title="บัญชีและข้อมูลร้านค้า">
            ...
            และรับผิดชอบกิจกรรมที่เกิดขึ้นผ่านบัญชี
            ห้ามสวมรอยหรือสร้างร้านค้าที่ทำให้ผู้อื่นเข้าใจผิด
          </LegalSection>
          <LegalSection title="การจองและระยะเวลาถือบูธ">
            การเลือกบูธที่ว่างและยืนยันรายการจะสร้างการจองสถานะรอชำระเงินทันที
            บูธจะถูกถือไว้ตามเวลาที่แสดงในรายการ หากไม่ชำระเงินสำเร็จภายในเวลา
            ระบบอาจยกเลิกการจองและเปิดบูธให้ผู้อื่น
          </LegalSection>
          <LegalSection title="การชำระเงิน การยกเลิก และคืนเงิน">
            ผู้ใช้ต้องตรวจสอบ Event บูธ ราคา และข้อมูลผู้รับเงินก่อนส่งหลักฐาน
            ผลตรวจสลิปที่ผ่านจะยืนยันการจองโดยอัตโนมัติ
            เงื่อนไขการยกเลิกและยอดคืนเงินขึ้นอยู่กับสถานะรายการ ช่วงเวลาของ
            Event และการพิจารณาตามข้อมูลที่ระบบรองรับ
          </LegalSection>
          ...
          <LegalSection title="ข้อจำกัดของบริการ">
            SpaceLink เป็นโครงงานมหาวิทยาลัย
            ฟังก์ชันและความพร้อมใช้งานอาจเปลี่ยนแปลงหรือหยุดชั่วคราว ข้อมูล
            Event และรายละเอียดผู้จัดงานมาจากผู้ใช้งานที่เกี่ยวข้อง
            ผู้ใช้ควรตรวจสอบข้อมูลสำคัญก่อนตัดสินใจ หากพบปัญหาให้ติดต่อผ่านหน้า{' '}
            <Link
              href="/help"
        ...
        <aside className="mt-7 rounded-2xl border border-[#d9cdf0] bg-violet-tint px-5 py-4 text-sm leading-7 text-[#4d3c68]">
          ...
          เอกสารนี้เป็นฉบับเบื้องต้นสำหรับโครงงานมหาวิทยาลัย
          ไม่ใช่คำปรึกษาทางกฎหมาย และควรให้ผู้เชี่ยวชาญตรวจทานก่อนนำไปใช้จริง
          ดูตัวอย่างแนวทางการกำหนดเงื่อนไขได้จาก{' '}
          <a
            href="https://www.etda.or.th/th/term-of-use.aspx"
            target="_blank"
            rel="noreferrer"
