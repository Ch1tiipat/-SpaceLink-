...
export function AdminBookingsScreen({
  ...
  return (
    <AdminPanel
      title="รายการจอง"
      description="ข้อมูลจำกัดตามองค์กรและตัวกรองด้านบน"
      actions={
        <Link
          href={`/admin/booking-rescue?${new URLSearchParams({ organization: organizationId })}`}
          className="inline-flex h-9 items-center rounded-xl bg-violet px-3 text-xs font-extrabold text-white"
        >
