  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/70 bg-white/80 backdrop-blur-xl">
      <div className="shell flex h-[76px] items-center justify-between">
        <Link href="/" className="flex items-center gap-3" aria-label="SpaceLink หน้าหลัก">
          ...
          <span className="text-xl font-extrabold tracking-[-0.03em]">SpaceLink</span>
        </Link>
        ...
        <nav className="hidden items-center gap-7 text-sm font-semibold text-[#645f72] md:flex">
          ...
          <a href="#how-it-works">วิธีจองพื้นที่</a>
