          ...
          <aside className="grid gap-5">
            ...
            {cancellable ? (
              <section className="sl-surface p-5">
                ...
                <textarea value={cancelReason} onChange={(event) => setCancelReason(event.target.value)} rows={3} placeholder="เหตุผลที่ต้องการยกเลิก" className="mt-4 w-full rounded-xl border border-line px-4 py-3 text-sm outline-none focus:border-violet" />
