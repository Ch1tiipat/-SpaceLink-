# SpaceLink — SCRUM-83 Discovery, Quick Support and Event Map CTA Handoff

อัปเดต: 21 สิงหาคม 2026

ผู้รับช่วงต่อ: บุ๊ค / ปอนด์ / ทีม SpaceLink

Ticket: `SCRUM-83` — ปรับปรุงหน้า Discovery, ปุ่มช่วยเหลือด่วน และ CTA จองพื้นที่บน Event Map

ผู้อนุมัติ Scope: `book`

Branch: `codex/scrum-83-discovery-support-event-map-cta`

## สถานะ

ปรับ UX/UI ฝั่งผู้ขายตามขอบเขตที่ `book` อนุมัติแล้ว พร้อมส่งให้ทีมตรวจ Code Review และ CI ก่อน merge เข้า `main`
...
2. `apps/web/components/app-shell.tsx`
   - ปรับ Floating Contact Button เป็นกล่องข้อความ “คำถามที่พบบ่อย · ติดต่อเรา”
